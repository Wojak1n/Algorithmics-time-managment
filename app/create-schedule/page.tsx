                  ...
                  {courses.map((course) => (
                    <SelectItem key={course.id} value={course.id}>
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-500">- {course.subject.name}</span>
                      </div>
                    </SelectItem>
                  ))}
                </SelectContent>
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{selectedCourseData.subject.name} ({selectedCourseData.subject.code})</span>
                  </div>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{selectedCourseData.weeklySessions}</span>
                  </div>
                  {selectedCourseData.room && (
                    <div className="flex items-center space-x-2">
                      <span className="font-medium">Room:</span>
                      <span>{selectedCourseData.room.name}</span>
                    </div>
                  )}
                </div>
              </div>
